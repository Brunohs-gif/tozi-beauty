  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-end justify-center sm:items-center sm:p-6">
      ...
      <div
        ...
        className="relative z-10 max-h-[88vh] w-full max-w-xl overflow-y-auto rounded-t-2xl bg-cream p-8 shadow-2xl sm:rounded-sm sm:p-12"
      >
        <button
          ref={closeButtonRef}
          type="button"
          onClick={onClose}
          aria-label="Fechar"
          className="absolute right-5 top-5 rounded-full p-2 text-coffee/60 transition-colors hover:bg-sand hover:text-ink"
        >
        ...
        <a
          href="#agendar"
          onClick={onClose}
          className="mt-9 inline-block rounded-full bg-ink px-7 py-3.5 text-[13px] uppercase tracking-widest text-cream transition-colors hover:bg-coffee"
        >
          Agendar avaliação
        </a>
      </div>
