import { HandHeart, Microscope, ShieldCheck, Sparkle } from '@phosphor-icons/react'
import { aboutSecondaryImage, clinicianImage } from '../../config/images'
import { Eyebrow } from '../ui/Eyebrow'
import { RevealOnScroll } from '../ui/RevealOnScroll'

const highlights = [
  { icon: HandHeart, label: 'Atendimento individualizado' },
  { icon: Microscope, label: 'Protocolos personalizados' },
  { icon: Sparkle, label: 'Naturalidade como princípio' },
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        <div className="grid gap-16 lg:grid-cols-12 lg:gap-8">
          ...
          <RevealOnScroll className="relative lg:col-span-5">
            <div className="relative w-4/5 rounded-[1.75rem] bg-sand/60 p-2 ring-1 ring-coffee/10">
              <div className="aspect-[3/4] w-full overflow-hidden rounded-[1.35rem] bg-sand">
                <img
                  src={clinicianImage}
            ...
            <div className="absolute -bottom-10 -right-2 aspect-[4/5] w-2/5 overflow-hidden rounded-[1rem] border-4 border-cream bg-sand shadow-soft sm:-right-6">
              <img
            ...
            <div className="absolute -left-2 top-6 flex h-20 w-20 flex-col items-center justify-center rounded-full border border-gold/50 bg-cream text-center shadow-soft sm:-left-6">
          ...
          <div className="lg:col-span-7 lg:pl-8">
            <RevealOnScroll>
              <Eyebrow>Sobre a TOZI</Eyebrow>
              <h2 className="mt-5 max-w-xl font-serif text-4xl leading-tight text-ink sm:text-5xl">
              ...
              {highlights.map((item, index) => (
                <RevealOnScroll key={item.label} as="li" delay={150 + index * 60}>
                  <div className="flex items-start gap-3">
                    <item.icon className="mt-0.5 h-5 w-5 shrink-0 text-terracotta" weight="light" aria-hidden="true" />
